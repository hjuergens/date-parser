...
public class AppTest
{
    ...
    @Test
    public void runAll() throws IllegalAccessException, InstantiationException, ClassNotFoundException, ScriptException {
        Overview.main(new String[]{});
        JavaApp.main(new String[]{});
        JavaScriptApp.main(new String[]{});
        JythonApp.main(new String[]{});
    }
